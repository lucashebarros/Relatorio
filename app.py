...
4. Tem sistema de chamado interno para o ADM
5. Impede de compartilhar dashboards por link
6. Tem um sistema de notificação, inclusive notificação de manutenção o dashboard
""")
